<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Caciquat Hotel Admin</title>
						...
						<div class="col-lg-10 contact-right"> 
                            ...
                            <div class="row">
                                 <div class="container">
                                    ...
                                    <form class="booking-form"  action="../update/updateP.php" enctype="multipart/form-data" method="post">
                                        <div class="row">  
                                             <div class="col-lg-12 d-flex flex-column">
                                                <label for="title">Title</label>
                                                <input name="title"  onfocus="this.placeholder = ''" id="title" onblur="this.placeholder = 'Title'" value="<?php echo $title ?>"   class="form-control mt-20" required="" type="text"> 
                                            </div> 

                                            <div class="col-lg-12 d-flex flex-column">
                                                <label for="description">Description</label> 
                                                <textarea class="form-control mt-20" name="description" id="description"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required=""><?php echo $body  ?></textarea> 
                                            ...
                                            <div class="col-lg-12 d-flex flex-column">
                                                ...
                                                <select name="categorie" value="<?php echo $categorie ?>" placeholder="categorie" onfocus="this.placeholder = 'Categorie'" onblur="this.placeholder = 'Categorie'"   class="form-control mt-20" id="categorie">
                                            ...
                                            <div class="col-lg-12 d-flex flex-column"> 
                                                ...
                                                <input name="autor"  onfocus="this.placeholder = ''" id="autor" onblur="this.placeholder = 'autor'" class="form-control mt-20" required value="<?php echo $nom.' '.$prenom ?>" readOnly> 
                                            </div>  

                                            <div class="col-lg-12 d-flex  justify-content-end send-btn" >
                                                <input class="btn btn-default primary-btn mt-20 text-uppercase lnr lnr-arrow-right" value="Update Post" name="body" id="body" type="submit">
                                            </div>  
